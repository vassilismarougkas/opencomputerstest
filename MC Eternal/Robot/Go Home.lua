...
waypoint = getWaypoint("NIUG13", 32)
local height = 25
if (waypoint == nil) then
    waypoint = getWaypoint("NIUG13", 64)
    height = 40
end
if (waypoint == nil) then
    waypoint = getWaypoint("NIUG13", 128)
    height = 75
end
if (waypoint == nil) then
    waypoint = getWaypoint("NIUG13", 256)
    height = 150
end
if (waypoint == nil) then
    print("Could not find the base's waypoint!")
    return nil
end
goHeight(height)
goHorizontial()
