...
local function update()
    ...
    repeat
        ...
        if not file == nil then
            download("/data/flash/"..file, "/apt/flashloader/flashes/"..file)
        end
    until file == nil
    list = nil
...
if (#tArgs == 2) then
    if (tArgs[1] == "download") then
        download("/data/flash/"..tArgs[2], "/apt/flashloader/flashes/"..tArgs[2])
        return nil
    end
    if (tArgs[1] == "flash") then
        ...
        shell.execute("flash -q /data/flash/"..tArgs[2])
        return nil
    end
    printUsage()
end
